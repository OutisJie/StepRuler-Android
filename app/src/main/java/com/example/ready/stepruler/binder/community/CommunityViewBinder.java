...
public class CommunityViewBinder extends ItemViewBinder<CommunityBean,CommunityViewBinder.ViewHolder> {
    private static final String Tag = "CommunityViewBinder";
        ...
        try {
            ...
            getUserInfo.enqueue(new Callback<List<String>>() {
                ...
                public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                    ...
                    ImageLoadUtil.loadCenterCrop(context, response.body().get(1), holder.usericon, R.color.viewBackground, R.drawable.ice_user_header);
                }
            ...
            //评论显示
            Call<ArrayList<CommentBean>> getCommentsB = commentApi.getComments(item.getCommunityId());
            getCommentsB.enqueue(new Callback<ArrayList<CommentBean>>() {
                @Override
                public void onResponse(Call<ArrayList<CommentBean>> call, Response<ArrayList<CommentBean>> response) {
